...
**robbit**はFPGAを活用する扱いやすいtwo-wheeled self-balancing robot(TW-SBR)である。
...
さらなる詳細は、robbitフォルダ内のREADMEを参照してほしい
...
- MadgwickAHRS ライブラリ
    ...
    - ライセンス全文は本リポジトリに同梱（[COPYING.LESSER](./robbit/setting/new_files/Madgwick/COPYING.LESSER)）されています。

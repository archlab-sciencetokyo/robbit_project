...
# sed -i '#^GPP[ \t ]*:= /tools/cad/riscv/rv32ima/bin/riscv32-unknown-elf-g++$#a LINK := /tools/cad/riscv/rv32ima/bin/riscv32-unknown-elf-ar' ./CFU-Proving-Ground/Makefile
